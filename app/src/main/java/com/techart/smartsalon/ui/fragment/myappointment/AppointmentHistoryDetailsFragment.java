...
public class AppointmentHistoryDetailsFragment extends BaseFragment implements MyAppointmentDetailsView{
    ...
    public static Fragment newInstance(String id) {
        AppointmentHistoryDetailsFragment appointmentDetailsFragment=new AppointmentHistoryDetailsFragment();
